...
object UsersInfo {
  ...
  private var _activeProductCommand: mutable.Map[Products.Product, Int] = mutable.Map()

  // List of the general product ordered by the user
  private var _activeBrandCommand: mutable.Map[Products.Brand, Int] = mutable.Map()
  ...
  /**
    ...
    */
  def addBrand(brand: Products.Brand, num: Int): mutable.Map[Products.Brand, Int] = _activeBrandCommand += (brand -> num)
